...
export const Timeline = ({ data }: { data: TimelineEntry[] }) => {
  ...
  return (
    <div className="w-full md:px-10" ref={containerRef}>
      {/* TÍTULO */}
      <div className="max-w-7xl mx-auto py-33 px-4 md:px-8 lg:px-10 text-center">
        <motion.h1
        ...
        <motion.p
          ...
          viewport={{ once: true }}
          className="text-nos-desc text-lg text-balance max-w-1xl mx-auto font-normal"
        >
        ...
        {data.map((item, index) => (
          ...
          >
            ...
            <div className="sticky flex flex-col md:flex-row z-40 items-center top-40 self-start max-w-xs lg:max-w-sm md:w-full">
              ...
              <h3 className="text-nos-fechas hidden md:block text-xl md:pl-20 md:text-5xl font-bold">
                {item.title}
              </h3>
            </div>

            {/* CONTENIDO */}
            <div className="relative pl-20 pr-3 md:pl-0 w-full">
