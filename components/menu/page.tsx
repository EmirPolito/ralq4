...
export default function LaboratorioPage() {
  ...
  return (
    <>
      <main className="flex-1 grid grid-cols-1 lg:grid-cols-[3fr_9fr_4fr] gap-3.5 min-h-0 max-w-[1700px] w-full">
        <aside className="min-h-0 bg-menu2-izq-bg rounded-xl border border-menu2-izq-buscador-borde shadow-xl p-3.5 overflow-hidden flex flex-col min-h-[350px] lg:min-h-0">
          <InstrumentSidebar
        ...
        <section className="flex flex-col gap-4 min-h-0">
          <div className="bg-menu2-izq-bg flex-1 backdrop-blur-md rounded-xl border border-menu2-centro-borde shadow-xl overflow-hidden min-h-0 min-h-[350px] lg:min-h-0">
            <InstrumentViewer activeItem={activeItem} viewMode={viewMode} />
          </div>

          <div className="flex-1 min-h-[160px] lg:max-h-[201px]">
            <BottomSections
              data={combinedData}
        ...
        {/* Derecha: Detalles */}
        <aside className="min-h-0 lg:overflow-y-auto custom-scrollbar bg-menu2-derecha-bg rounded-xl border border-menu2-derecha-borde shadow-xl px-3.5 py-6 sm:p-6">
